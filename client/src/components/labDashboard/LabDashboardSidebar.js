  ...
  return (
    <div className="h-screen overflow-y-hidden w-screen grid grid-cols-12">
      <div className="side_bar bg-white shadow col-span-2">
        ...
        <div className=" ">
          <button className="mx-auto py-1 px-2 mt-80 text-white bg-blue-500  rounded font-semibold shadow-sm hover:text-blue-500 border border-blue-500  hover:bg-white font-bold  flex items-center" onClick={logout}>
