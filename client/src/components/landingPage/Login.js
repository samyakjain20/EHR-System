...
export default function Login(props) {
  ...
  return (
    <div className="bg-white flex flex-col justify-items-center items-center py-8 mt-8 px-24 mr-19 rounded-lg shadow-md lg:w-5/6 w-full my-4 ml-auto ">
      ...
      <div className="flex bg-blue-100 w-fit justify-between rounded mt-4">
        <button
          className={
            Toggle === "Patient"
              ? "py-2 px-5 text-lg text-white  font-semibold cursor-pointer rounded bg-blue-500"
              : "py-2 px-5 text-lg  font-medium text-primary cursor-pointer rounded"
          }
          onClick={() => {
            setToggle("Patient");
            setUsername("");
